...
internal static class PlatformUtils
{
    ...
    public static void SetPlatform()
    {
        if (PlatformDetection.OS is OSKind.Windows)
        {
            ...
            if (ntDll != IntPtr.Zero)
            {
                ...
                if (wineGetVersion != IntPtr.Zero)
                {
                    ...
                    var getVersion =
                        Marshal.GetDelegateForFunctionPointer(wineGetVersion, typeof(GetWineVersionDelegate)) as
                            GetWineVersionDelegate;
        ...
        else if (PlatformDetection.OS is OSKind.OSX)
        {
            ...
            LinuxArchitecture = utsname_osx.machine;
            LinuxKernelVersion = utsname_osx.version;
        }
    }
